...
# Number of proposals to use, if not enough padding to this number
__C.TRAIN.CONTEXT_NUM_ROIS = 700
...
# Grid stride for GRID_RPM
__C.GRID_STRIDE = [32,]

# Define the grid size around the keypoint
__C.GRID_SIZE = [3, 3]
